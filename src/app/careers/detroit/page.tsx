// Careers Detroit (/careers/detroit)
"use client";
  ...
  return (
    <div className="min-h-screen bg-[#fefdfb] text-[#454545] overflow-x-hidden">
      ...
      <section className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 pt-16 sm:pt-20">
        <div className="max-w-4xl mx-auto text-center">
          <div className="fade-up inline-flex items-center gap-2 px-4 sm:px-5 py-2 sm:py-2.5 bg-white rounded-full border border-[#eee] mb-6 sm:mb-10 shadow-sm">
            ...
            <span className="text-xs sm:text-sm font-medium text-[#666]">Detroit · Actively Interviewing</span>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-start">
            <div className="fade-up order-2 lg:order-1">
              <div className="mb-8 sm:mb-12">
                <img src="/house-manager.svg" alt="House manager illustration" className="w-full max-w-sm mx-auto" />
              </div>
              ...
              <div className="relative lg:sticky lg:top-32">
                ...
                <div className="relative w-full bg-white rounded-2xl sm:rounded-3xl shadow-xl p-6 sm:p-10 border border-[#eee]">
                  ...
                  <div className="space-y-4 sm:space-y-5">
                    {[
                      { title: "Flexible hours", desc: "Built around your schedule." },
                      { title: "A family that sees you", desc: "Essential, not invisible." },
                      { title: "HUM in your corner", desc: "Training, community, backup." },
                      { title: "A career, not a gig", desc: "1 year minimum." },
                    ].map((item, i) => (
                      <div key={i} className="flex items-start gap-3">
                        ...
                        <div>
                          <p className="text-base sm:text-xl font-medium text-[#323B46]">{item.title}</p>
                          <p className="text-base sm:text-xl text-[#666]">{item.desc}</p>
                        </div>
                      </div>
                    ))}
                  </div>
            ...
            <div className="order-1 lg:order-2">
              <p className="fade-up text-xs uppercase tracking-widest text-[#a67c64] mb-4 sm:mb-6 text-center lg:text-left">The Role</p>
              <h2 className="fade-up fade-up-delay-1 text-[30px] sm:text-[44px] md:text-[56px] font-semibold leading-[1.1] tracking-tight mb-4 sm:mb-6 text-center lg:text-left">Your days</h2>
              <p className="fade-up fade-up-delay-2 text-base sm:text-xl text-[#666] leading-relaxed mb-8 sm:mb-12 text-center lg:text-left">What you do depends on the family.</p>
              ...
              <div className="space-y-2 sm:space-y-4">
                {[
                  ...
                  <div key={i} className={`fade-up fade-up-delay-${Math.min(i % 4 + 1, 4)} group flex items-start gap-3 sm:gap-5 p-3 sm:p-5 rounded-xl sm:rounded-2xl hover:bg-[#f7f7f7] transition-all duration-300`}>
      ...
      <section className="min-h-[auto] sm:min-h-screen flex items-center justify-center px-4 sm:px-6 py-16 sm:py-0 bg-gradient-to-b from-white to-stone-50">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8 sm:mb-16">
            <p className="fade-up text-xs uppercase tracking-widest text-[#a67c64] mb-3 sm:mb-6">Who You'll Work For</p>
            <h2 className="fade-up fade-up-delay-1 text-[30px] sm:text-[44px] md:text-[56px] font-semibold leading-[1.15] sm:leading-[1.1] tracking-tight mb-4 sm:mb-6">The families</h2>
            <p className="fade-up fade-up-delay-2 text-sm sm:text-xl md:text-2xl text-[#666] max-w-2xl mx-auto">Here&apos;s what we require from every family.</p>
          </div>
          ...
          <div className="grid sm:grid-cols-3 gap-8 sm:gap-16 text-center max-w-4xl mx-auto">
            <div className="fade-up fade-up-delay-2">
              ...
              <h3 className="text-[18px] sm:text-[20px] font-semibold text-[#323B46] mb-2 sm:mb-3">They treat you like a professional</h3>
              <p className="text-sm sm:text-xl text-[#666] leading-relaxed">Fair pay. Clear boundaries. No midnight texts.</p>
            </div>
            ...
            <div className="fade-up fade-up-delay-3">
              ...
              <h3 className="text-[18px] sm:text-[20px] font-semibold text-[#323B46] mb-2 sm:mb-3">They communicate and appreciate</h3>
              <p className="text-sm sm:text-xl text-[#666] leading-relaxed">Clear expectations. Open feedback. You&apos;re essential, not invisible.</p>
            </div>
            ...
            <div className="fade-up fade-up-delay-4">
              ...
              <h3 className="text-[18px] sm:text-[20px] font-semibold text-[#323B46] mb-2 sm:mb-3">They&apos;re vetted too</h3>
              <p className="text-sm sm:text-xl text-[#666] leading-relaxed">Background checked. Trial period before either side commits.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="min-h-[auto] sm:min-h-screen flex items-center justify-center px-4 sm:px-6 py-16 sm:py-0 bg-[#fefdfb]">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8 sm:mb-16">
            <p className="fade-up text-xs uppercase tracking-widest text-[#a67c64] mb-3 sm:mb-6">Experience & Fit</p>
            <h2 className="fade-up fade-up-delay-1 text-[30px] sm:text-[44px] md:text-[56px] font-semibold leading-[1.15] sm:leading-[1.1] tracking-tight">Who thrives here</h2>
          </div>
          ...
          <div className="grid sm:grid-cols-2 gap-2 sm:gap-5">
            {[
              ...
              <div key={i} className={`fade-up fade-up-delay-${Math.min(i % 4 + 1, 4)} flex items-start gap-2 sm:gap-4 p-3 sm:p-6 bg-white rounded-xl sm:rounded-2xl border border-[#eee] hover:shadow-lg hover:border-[#ccc] transition-all duration-300`}>
      ...
      <section className="min-h-[auto] sm:min-h-screen flex items-center justify-center px-4 sm:px-6 py-16 sm:py-0 bg-gradient-to-b from-stone-50 to-white">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8 sm:mb-16">
            <p className="fade-up text-xs uppercase tracking-widest text-[#a67c64] mb-3 sm:mb-6">Why HUM</p>
            <h2 className="fade-up fade-up-delay-1 text-[30px] sm:text-[44px] md:text-[56px] font-semibold leading-[1.15] sm:leading-[1.1] tracking-tight mb-4 sm:mb-6">You&apos;re not alone</h2>
            <p className="fade-up fade-up-delay-2 text-sm sm:text-xl md:text-2xl text-[#666] max-w-2xl mx-auto">We don&apos;t disappear after we place you.</p>
          </div>
          ...
          <div className="grid sm:grid-cols-3 gap-8 sm:gap-16 text-center max-w-4xl mx-auto">
            <div className="fade-up fade-up-delay-2">
              ...
              <h3 className="text-[18px] sm:text-[20px] font-semibold text-[#323B46] mb-2 sm:mb-3">A playbook for every home</h3>
              <p className="text-sm sm:text-xl text-[#666] leading-relaxed">Every family has a Home Operating System. No guessing.</p>
            </div>
            ...
            <div className="fade-up fade-up-delay-3">
              ...
              <h3 className="text-[18px] sm:text-[20px] font-semibold text-[#323B46] mb-2 sm:mb-3">AI copilot at your fingertips</h3>
              <p className="text-sm sm:text-xl text-[#666] leading-relaxed">Forgot something? Our AI copilot gives instant answers.</p>
            </div>
            ...
            <div className="fade-up fade-up-delay-4">
              ...
              <h3 className="text-[18px] sm:text-[20px] font-semibold text-[#323B46] mb-2 sm:mb-3">We&apos;re in your corner</h3>
              <p className="text-sm sm:text-xl text-[#666] leading-relaxed">Training, community, ongoing support. Your success is our success.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="min-h-[auto] sm:min-h-screen flex items-center justify-center px-4 sm:px-6 py-16 sm:py-0 bg-[#fefdfb] relative overflow-hidden">
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          <a href="#apply" className="fade-up fade-up-delay-1 inline-flex items-center gap-2 sm:gap-3 px-6 sm:px-12 py-3.5 sm:py-6 bg-[#454545] text-white text-sm sm:text-lg font-semibold rounded-full hover:bg-[#323B46] transition-all duration-300 hover:shadow-2xl hover:scale-105">
            Apply Now
      ...
      <section id="apply" className="py-12 sm:py-24 px-4 sm:px-6 bg-[#fefdfb]">
        <div className="max-w-4xl mx-auto">
          <div className="fade-up text-center mb-8 sm:mb-12">
            <p className="text-xs uppercase tracking-widest text-[#a67c64] mb-3 sm:mb-4">Apply Now</p>
            <h2 className="text-[30px] sm:text-[44px] md:text-[56px] font-semibold text-[#454545] leading-tight mb-3 sm:mb-4">Ready?</h2>
            <p className="text-sm sm:text-xl text-[#666] max-w-xl mx-auto">We&apos;ll ask about your experience and how you keep things running.</p>
          </div>
          ...
          <div className="max-w-2xl mx-auto mb-8 sm:mb-12">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-0">
              ...
              <svg className="hidden sm:block w-8 h-8 text-[#ccc] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" /></svg>
              <svg className="sm:hidden w-5 h-5 text-[#ccc] rotate-90" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" /></svg>
              <div className="flex flex-col items-center text-center">
                <div className="w-10 sm:w-14 h-10 sm:h-14 rounded-full bg-stone-100 flex items-center justify-center mb-2 sm:mb-3">
            ...
            <p className="text-center text-xs sm:text-xl text-[#888] mt-4 sm:mt-6">If you&apos;re a good fit, we&apos;ll reach out in most cases within 24 hours.</p>
          </div>
          ...
          <div className="max-w-2xl mx-auto mb-8 sm:mb-12 p-4 sm:p-8 bg-stone-50 rounded-xl sm:rounded-2xl border border-[#e5e5e5]">
            ...
            <p className="text-sm sm:text-xl text-[#666] mb-3 sm:mb-4">We&apos;ll ask you to describe a system you&apos;ve built to run a home like a pro. Doesn&apos;t have to be fancy. We just want to know how you think.</p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4">
            ...
            <div className="flex flex-wrap justify-center gap-x-4 sm:gap-x-6 gap-y-1 sm:gap-y-2">
              <a href="/" className="text-[10px] sm:text-xs text-[#999] hover:text-[#666] transition-colors">Home</a>
              <a href="/privacy-policy" className="text-[10px] sm:text-xs text-[#999] hover:text-[#666] transition-colors">Privacy Policy</a>
              <a href="/terms-of-service" className="text-[10px] sm:text-xs text-[#999] hover:text-[#666] transition-colors">Terms of Service</a>
              <a href="/disclaimer" className="text-[10px] sm:text-xs text-[#999] hover:text-[#666] transition-colors">Disclaimer</a>
              <a href="/cookie-policy" className="text-[10px] sm:text-xs text-[#999] hover:text-[#666] transition-colors">Cookie Policy</a>
            </div>
            <p className="text-[10px] sm:text-xs text-[#bbb]">© {new Date().getFullYear()} HUM</p>
          </div>
        </div>
      </footer>
    </div>
